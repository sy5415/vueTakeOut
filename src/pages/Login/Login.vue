<template>
  <section class="loginContainer">
          ...
          <form>
            <div :class="{on:isShowMsg}">
              <section class="login_message">
                ...
                <button :disabled="!isRightPhone" class="get_verification" :class="{right_phone_number:isRightPhone}" @click.prevent="sure">获取验证码</button>
              </section>
      ...
      <a href="" @click="$router.push('/msite')">返回</a>
  </section>
</template>
